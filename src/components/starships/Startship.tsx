...
export default function Startship() {
  ...
  const [item, setItem] = useState<StarshipsInterface>();
  ...
  return (
    <div className="mt-4">
      <div className="grid grid-cols-12 border-[1px] border-[#423D3D] bg-[#29292E] w-full p-6 rounded-lg">
        ...
        <div className="text-[#A7A7A7] text-base col-span-3">MGLT:</div>
        <div className="col-span-9 text-[#C4C4CC] text-lg">{item?.MGLT}</div>
